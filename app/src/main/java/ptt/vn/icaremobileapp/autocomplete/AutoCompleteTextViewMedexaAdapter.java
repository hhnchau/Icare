...
public class AutoCompleteTextViewMedexaAdapter extends ArrayAdapter<MedexaHDomain> {
    private List<MedexaHDomain> lists;
    private String chr = "";

    public AutoCompleteTextViewMedexaAdapter(@NonNull Context context, @NonNull List<MedexaHDomain> lists) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        final MedexaHDomain complete = getItem(position);
    ...
    private Filter filter = new Filter() {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            List<MedexaHDomain> suggestions = new ArrayList<>();
        ...
        public CharSequence convertResultToString(Object resultValue) {
            return ((MedexaHDomain) resultValue).getName();
        }
    };

    public void setItems(List<MedexaHDomain> lists) {
        this.lists = lists;
    }
}
