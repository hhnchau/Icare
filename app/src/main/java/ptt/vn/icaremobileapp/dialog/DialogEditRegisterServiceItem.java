...
public class DialogEditRegisterServiceItem {
    private static DialogEditRegisterServiceItem instance = null;

    public static DialogEditRegisterServiceItem getInstance() {
        if (instance == null) {
            instance = new DialogEditRegisterServiceItem();
        }
        return instance;
    }
    ...
    public void show(final Context context, final RegisterServiceOrder serviceItem, final OnClickListener onClickListener) {
