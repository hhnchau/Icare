...
public class DrugOrderOutSideAdapter extends RecyclerView.Adapter<DrugOrderOutSideAdapter.MyViewHolder> {
    private List<Integer> expand = new ArrayList<>();
    private List<String> lists;

    public DrugOrderOutSideAdapter(List<String> lists) {
        this.lists = lists;
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.drugorderoutside_item, parent, false);
