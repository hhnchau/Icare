...
public class HistoryClinicDiagnoseAdapter extends RecyclerView.Adapter<HistoryClinicDiagnoseAdapter.MyViewHolder> {
    private List<OutDiagnoseHeaderDomain> lists;
    private Context context;

    public HistoryClinicDiagnoseAdapter(List<OutDiagnoseHeaderDomain> lists) {
        this.lists = lists;
    }
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, final int position) {
        final OutDiagnoseHeaderDomain parent = lists.get(holder.getAdapterPosition());
        if (parent != null) {
            ...
            final HistoryClinicDiagnoseChildAdapter adapter = new HistoryClinicDiagnoseChildAdapter(lstChild);
    ...
    public void setItems(List<OutDiagnoseHeaderDomain> lists) {
        this.lists = lists;
    }
