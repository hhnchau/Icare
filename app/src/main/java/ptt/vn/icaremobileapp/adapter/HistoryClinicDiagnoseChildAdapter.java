...
public class HistoryClinicDiagnoseChildAdapter extends RecyclerView.Adapter<HistoryClinicDiagnoseChildAdapter.MyViewHolder> {
    private Context context;
    private List<OutDiagnoseDomain> lists;

    public HistoryClinicDiagnoseChildAdapter(List<OutDiagnoseDomain> lists) {
        this.lists = lists;
    }
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, final int position) {
        final OutDiagnoseDomain child = lists.get(position);
        if (child != null) {

            holder.tvDetail.setText(child.getCodeicdx());
    ...
    public void setItems(List<OutDiagnoseDomain> lists) {
        this.lists = lists;
    }
