...
public class RegisterServiceOrderAdapter extends RecyclerView.Adapter<RegisterServiceOrderAdapter.MyViewHolder> {
    private List<Integer> expand = new ArrayList<>();
    private List<RegisterServiceOrder> lists;
    private Context context;

    public RegisterServiceOrderAdapter(List<RegisterServiceOrder> lists) {
        this.lists = lists;
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, final int position) {
        ...
        final RegisterServiceOrder serviceItem = lists.get(holder.getAdapterPosition());
...
//                    });
    ...
    public void setItems(List<RegisterServiceOrder> lists) {
        this.lists = lists;
