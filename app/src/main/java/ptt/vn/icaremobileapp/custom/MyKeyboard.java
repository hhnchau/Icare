...
public class MyKeyboard extends KeyboardView {
    ...
    public void registerEditText(MyAutoCompleteTextView v) {
        //MyInputTextOutline edittext = ((Activity) getContext()).findViewById(resId);
        ...
        v.setInputType(v.getInputType() | InputType.TYPE_TEXT_FLAG_NO_SUGGESTIONS);
    }
...
//        ConstraintLayout.LayoutParams relativeLayoutParams = (ConstraintLayout.LayoutParams) getLayoutParams();
