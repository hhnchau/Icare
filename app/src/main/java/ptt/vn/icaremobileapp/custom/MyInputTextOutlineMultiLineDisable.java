...
public class MyInputTextOutlineMultiLineDisable extends LinearLayout {
    ...
    public MyInputTextOutlineMultiLineDisable(@NonNull Context context) {
        super(context);
        this.context = context;
        create(this.context);
    }

    public MyInputTextOutlineMultiLineDisable(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    public MyInputTextOutlineMultiLineDisable(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void create(Context context) {
        ...
        if (inflater != null) {
            inflater.inflate(R.layout.my_inputtext_outline_multiline_disable, this);
