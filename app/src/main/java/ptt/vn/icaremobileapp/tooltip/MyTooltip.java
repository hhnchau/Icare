package ptt.vn.icaremobileapp.tooltip;
...
public class MyTooltip {
    ...
    private MyTooltip(MyContext myContext, View view) {
        this.view = view;
    ...
    private MyTooltip(MyContext myContext, View rootView, View view) {
    ...
    private MyTooltip(View view) {
        this(new MyContext(getActivityContext(view.getContext())), view);
    }

    public static MyTooltip on(final View view) {
        return new MyTooltip(new MyContext(getActivityContext(view.getContext())), view);
    }

    public static MyTooltip on(Fragment fragment, final View view) {
        return new MyTooltip(new MyContext(fragment), view);
    }

    public static MyTooltip on(Activity activity, final View view) {
        return new MyTooltip(new MyContext(getActivityContext(activity)), view);
    }

    public static MyTooltip on(Activity activity, final View rootView, final View view) {
        return new MyTooltip(new MyContext(getActivityContext(activity)), rootView, view);
    }
    ...
    public MyTooltip position(Position position) {
        this.tooltip_view.setPosition(position);
        return this;
    }

    public MyTooltip withShadow(boolean withShadow) {
        this.tooltip_view.setWithShadow(withShadow);
        return this;
    }

    public MyTooltip shadowColor(@ColorInt int shadowColor) {
        this.tooltip_view.setShadowColor(shadowColor);
        return this;
    }

    public MyTooltip customView(View customView) {
        this.tooltip_view.setCustomView(customView);
        return this;
    }

    public MyTooltip customView(int viewId) {
        this.tooltip_view.setCustomView(((Activity) view.getContext()).findViewById(viewId));
        return this;
    }

    public MyTooltip arrowWidth(int arrowWidth) {
        this.tooltip_view.setArrowWidth(arrowWidth);
        return this;
    }

    public MyTooltip arrowHeight(int arrowHeight) {
        this.tooltip_view.setArrowHeight(arrowHeight);
        return this;
    }

    public MyTooltip arrowSourceMargin(int arrowSourceMargin) {
        this.tooltip_view.setArrowSourceMargin(arrowSourceMargin);
        return this;
    }

    public MyTooltip arrowTargetMargin(int arrowTargetMargin) {
        this.tooltip_view.setArrowTargetMargin(arrowTargetMargin);
        return this;
    }

    public MyTooltip align(ALIGN align) {
    ...
    public MyTooltip duration(long duration) {
        this.tooltip_view.setDuration(duration);
        return this;
    }

    public MyTooltip color(int color) {
        this.tooltip_view.setColor(color);
        return this;
    }

    public MyTooltip color(Paint paint) {
        this.tooltip_view.setPaint(paint);
        return this;
    }

    public MyTooltip onDisplay(ListenerDisplay listener) {
        this.tooltip_view.setListenerDisplay(listener);
        return this;
    }

    public MyTooltip onHide(ListenerHide listener) {
        this.tooltip_view.setListenerHide(listener);
        return this;
    }

    public MyTooltip padding(int left, int top, int right, int bottom) {
    ...
    public MyTooltip animation(TooltipAnimation tooltipAnimation) {
        this.tooltip_view.setTooltipAnimation(tooltipAnimation);
        return this;
    }

    public MyTooltip text(String text) {
        this.tooltip_view.setText(text);
        return this;
    }

    public MyTooltip text(@StringRes int text) {
        this.tooltip_view.setText(text);
        return this;
    }

    public MyTooltip corner(int corner) {
        this.tooltip_view.setCorner(corner);
        return this;
    }

    public MyTooltip textColor(int textColor) {
        this.tooltip_view.setTextColor(textColor);
        return this;
    }

    public MyTooltip textTypeFace(Typeface typeface) {
        this.tooltip_view.setTextTypeFace(typeface);
        return this;
    }

    public MyTooltip textSize(int unit, float textSize) {
        this.tooltip_view.setTextSize(unit, textSize);
        return this;
    }

    public MyTooltip setTextGravity (int textGravity) {
        this.tooltip_view.setTextGravity(textGravity);
        return this;
    }

    public MyTooltip clickToHide(boolean clickToHide) {
        this.tooltip_view.setClickToHide(clickToHide);
        return this;
    }

    public MyTooltip autoHide(boolean autoHide, long duration) {
        this.tooltip_view.setAutoHide(autoHide);
        this.tooltip_view.setDuration(duration);
        return this;
    }

    public MyTooltip distanceWithView(int distance) {
        this.tooltip_view.setDistanceWithView(distance);
        return this;
    }

    public MyTooltip border(int color,float width){
